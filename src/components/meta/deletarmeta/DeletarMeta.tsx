    ...
    <div className='min-h-screen bg-black text-white flex items-center justify-center'>
      <div className='container w-full md:w-1/3 mx-auto'>
        ...
        <p className='text-center text-gray-400 font-semibold mb-4'>
          Você tem certeza de que deseja apagar a meta a seguir?</p>
        <div className='bg-zinc-900 rounded-3xl shadow-lg shadow-orange-900/10 border border-orange-700/15 flex flex-col overflow-hidden justify-between'>
          <header
            className='py-3 px-6 bg-gradient-to-r from-orange-700 to-orange-800 text-white font-bold text-2xl'>
            Meta
          </header>
          ...
          <div className="flex" >
            ...
            <button
              className='w-full text-white bg-red-600 hover:bg-red-700 flex items-center justify-center' onClick={deletarMeta}>
              {isLoading ?
                <ClipLoader
                  color="#ffffff"
                  size={24}
