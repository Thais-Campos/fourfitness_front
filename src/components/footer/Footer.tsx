                    ...
                    <div>
                        <div className="flex items-center gap-3 group">
                            <div className="relative">
                                <div className="absolute inset-0 bg-zinc-900 rounded-2xl opacity-35 group-hover:opacity-55 transition-opacity" />
                                <div className="w-20 h-20 bg-zinc-900 rounded-2xl flex items-center justify-center shadow-md">
